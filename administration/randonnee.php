...
if(isset($_GET['id'])){
 ...
 //afficher les information sur une randonnée s'elle est existe
        ...
        ?>
            <div class="infos_randonnee">
                ...
                <ul class="">
                    ...
                    <li class="clearfix">
                        <button class="boutton randonnee_modifier"><a href="<?php echo OPERATION_ADMINISTRATION_PAGE
                                .'/modifier.php?id='.$id."#modifier" ?>">modifier les informations</a></button>
                    </li>
                </ul>
